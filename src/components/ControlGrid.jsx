    ...
    <div className="rounded-3xl bg-white p-5 shadow-sm border border-gray-100 flex flex-col h-full">
      ...
      <div className="space-y-1">
        ...
        <WeatherRow
          ...
          subValue={`Mức gió: ${v.fan_speed !== undefined && v.fan_speed !== null ? v.fan_speed : "N/A"}`}
          icon={
            <svg
              className="w-6 h-6"
              fill="none"
      ...
      <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-gray-100">
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-2xl border border-gray-100">
          <span className="text-xs font-bold text-gray-500">Chế độ thú cưng</span>
          <span
          ...
          >
            {Number(v.pet_mode) === 1 ? "BẬT" : "TẮT"}
          </span>
        </div>
        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-2xl border border-gray-100">
          <span className="text-xs font-bold text-gray-500">Chế độ cắm trại</span>
          <span
        ...
        <div className="flex items-center gap-1.5 pl-1 overflow-hidden">
          ...
          {hasValidCoords ? (
            <a
              ...
              title={v.location_address || "Mở bằng Google Maps"}
            >
